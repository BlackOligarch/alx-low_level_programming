...
"""
Defines a blueprint for a square for Advanced Task
"""


class Square:
    """
    A blueprint for working with a square
    """

    def __init__(self, size: int = 0):
        """
        Initializes the Square's class
    ...
    def area(self) -> int:
        """
        Computes & returns the area of the square
