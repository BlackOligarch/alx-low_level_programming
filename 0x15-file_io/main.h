...
#define BUFF_LEN 1024 /* macro defined */

/* exit codes */

#define INVALID_NARGS 97
#define NO_SUCH_FILE 98 /* the file doesn't exist or lack of permissions */
#define READ_FAIL 98
...
/*
 * prints an error msg when the file provided cannot be read from or user
...
/*
 * prints an error msg when the file provided cannot be written to or user
 * has limited privileges
 */
