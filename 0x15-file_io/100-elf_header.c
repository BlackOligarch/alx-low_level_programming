...
/**
 * handle_magic - It prints the magic numbers of an ELF header
 * @e_ident: a pointer to an array containing the ELF magic numbers
 */
...
/**
 * handle_class - It prints the class of an ELF header
 * @e_ident: a pointer to an array containing the ELF magic numbers
 */
...
/**
 * handle_osabi - It prints the OS/ABI of an ELF header
 * @e_ident: a pointer to an array containing the ELF magic numbers
 */
...
void handle_osabi(unsigned char *e_ident)
{
	...
	/* checks the cases to execute based on the value of e_ident */
...
/**
 * handle_abi - It prints the ABI version of an ELF header
 * @e_ident: a pointer to an array containing the ELF magic numbers
 */
...
/**
 * handle_type - It prints the type of an ELF header
...
void handle_type(unsigned int e_type, unsigned char *e_ident)
{
	...
	/* check cases to execute based on the value of e_type */
	switch (e_type)
	{
		case ET_NONE:
			printf("NONE (None)\n");
...
/**
 * handle_entry - It prints the entry point of an ELF header
...
/**
 * print_usage - It prints the usage & exits with code 98
 */
