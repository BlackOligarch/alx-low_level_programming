...
/**
 * free_listint2 - It frees memory allocated to a linked list of integers
...
void free_listint2(listint_t **head)
{
	...
	if (head == NULL)
		return; /* if the list is already empty, there's nothing to be free'd */
...
/**
 * _free - The safest way to free dynamically allocated memory
