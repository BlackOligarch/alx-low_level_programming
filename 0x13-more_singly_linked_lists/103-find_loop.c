...
/**
 * find_listint_loop - It detects a loop in the linked list
...
listint_t *find_listint_loop(listint_t *head)
{
	...
	return (NULL); /* If no loops were found */
}

/**
 * get_loop_start - It returns the starting point of a loop in the linked list
...
listint_t *get_loop_start(listint_t *slow_ptr, listint_t *head)
{
	...
	return (head); /* At the start of the loop */
}
