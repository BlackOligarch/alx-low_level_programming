...
/**
 * binary_to_uint - It converts a binary to an unsigned integer
...
unsigned int binary_to_uint(const char *b)
{
	...
	while (*b != '\0')
	{
		if (is_non_binary(*b))
		{
			return (0); /* If non-binary character encountered */
		}

		/* Then performs base 2 to base 10 arithmetic */
		base_10 = (base_10 << 1) | (_atoi(*b));
		b++;
	}

	return (base_10); /* The return value expected */
}
